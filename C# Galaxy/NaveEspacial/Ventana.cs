...
namespace NaveEspacial
{
    internal class Ventana
    {
        ...
        private void Init() 
        {
            ...
            _enemigo2 = new Enemigo(new Point(70, 20), ConsoleColor.Red, this, TipoEnemigo.Menu, null);
        ...
        public void Peligro()
        {
            ...
            for (int i = 0; i<10; i++)
            {
                ...
                Console.Write("¡¡PELIGRO!! LA COCA NO SE TOMA LICENCIA!!!!!!!!");
                Thread.Sleep(200);
                Console.SetCursorPosition(LimiteInferior.X / 2 - 5, LimiteInferior.Y / 2);
                Console.Write("                                               ");
                Thread.Sleep(200);
        ...
        {
            if (Console.KeyAvailable) //saber si presiono una tecla
            {
        ...
        public void CrearBalas()
        {
            ...
            _balas.Add(bala1);            
            Bala bala2 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala2);
            Bala bala3 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala3);
            Bala bala4 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala4);
            Bala bala5 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala5);
            Bala bala6 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala6);
            Bala bala7 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala7);
            Bala bala8 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala8);
            Bala bala9 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala9);
            Bala bala10 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala10);
            Bala bala11 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala11);
            Bala bala12 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala12);
            Bala bala13 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala13);
            Bala bala14 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala14);
            Bala bala15 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala15);
            Bala bala16 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala16);
            Bala bala17 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala17);
            Bala bala18 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala18);
            Bala bala19 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala19);
            Bala bala20 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
           _balas.Add(bala20);
