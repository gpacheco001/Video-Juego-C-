...
namespace NaveEspacial
{
    ...
    internal class Enemigo
    {
        ...
        public void DibujoNormal()
        {
            ...
            PosicionesEnemigo.Clear(); /*Elimina las posiciones anteriores*/
        ...
        public void Colisiones(Point posicionAux)
        {
            ...
            //Colisiones con marcos izquierdo y derecho
            ...
            //Colisiones con marcos superior e inferior
